...
podCount = df_filtered.groupby('podCount')[['MPEFT', 'IPPTS', 'HWS']].mean().reset_index()
alpha = df_filtered.groupby('alpha')[['MPEFT', 'IPPTS', 'HWS']].mean().reset_index()
# density = df_filtered.groupby('density')[['MPEFT', 'IPPTS', 'HWS']].mean().reset_index()
replicaCount = df_filtered.groupby('replicaCount')[['MPEFT', 'IPPTS', 'HWS']].mean().reset_index()
