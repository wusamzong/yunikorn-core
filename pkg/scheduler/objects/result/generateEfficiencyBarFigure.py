...
podCount = df_filtered.groupby('podCount')[['MPEFTefficiency', 'IPPTSefficiency', 'HWSefficiency']].mean().reset_index()
alpha = df_filtered.groupby('alpha')[['MPEFTefficiency', 'IPPTSefficiency', 'HWSefficiency']].mean().reset_index()
# density = df_filtered.groupby('density')[['MPEFTefficiency', 'IPPTSefficiency', 'HWSefficiency']].mean().reset_index()
replicaCount = df_filtered.groupby('replicaCount')[['MPEFTefficiency', 'IPPTSefficiency', 'HWSefficiency']].mean().reset_index()
ccr = df_filtered.groupby('CCR')[['MPEFTefficiency', 'IPPTSefficiency', 'HWSefficiency']].mean().reset_index()
speedHete = df_filtered.groupby('speedHete')[['MPEFTefficiency', 'IPPTSefficiency', 'HWSefficiency']].mean().reset_index()
nodeCount = df_filtered.groupby('nodeCount')[['MPEFTefficiency', 'IPPTSefficiency', 'HWSefficiency']].mean().reset_index()
tcr = df_filtered.groupby('TCR')[['MPEFTefficiency', 'IPPTSefficiency', 'HWSefficiency']].mean().reset_index()
actionCount = df_filtered.groupby('actionCount')[['MPEFTefficiency', 'IPPTSefficiency', 'HWSefficiency']].mean().reset_index()
