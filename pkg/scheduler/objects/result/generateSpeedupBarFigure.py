...
podCount = df_filtered.groupby('podCount')[['MPEFTspeedup', 'IPPTSspeedup', 'HWSspeedup']].mean().reset_index()
alpha = df_filtered.groupby('alpha')[['MPEFTspeedup', 'IPPTSspeedup', 'HWSspeedup']].mean().reset_index()
# density = df_filtered.groupby('density')[['MPEFTspeedup', 'IPPTSspeedup', 'HWSspeedup']].mean().reset_index()
replicaCount = df_filtered.groupby('replicaCount')[['MPEFTspeedup', 'IPPTSspeedup', 'HWSspeedup']].mean().reset_index()
ccr = df_filtered.groupby('CCR')[['MPEFTspeedup', 'IPPTSspeedup', 'HWSspeedup']].mean().reset_index()
speedHete = df_filtered.groupby('speedHete')[['MPEFTspeedup', 'IPPTSspeedup', 'HWSspeedup']].mean().reset_index()
nodeCount = df_filtered.groupby('nodeCount')[['MPEFTspeedup', 'IPPTSspeedup', 'HWSspeedup']].mean().reset_index()
tcr = df_filtered.groupby('TCR')[['MPEFTspeedup', 'IPPTSspeedup', 'HWSspeedup']].mean().reset_index()
actionCount = df_filtered.groupby('actionCount')[['MPEFTspeedup', 'IPPTSspeedup', 'HWSspeedup']].mean().reset_index()
